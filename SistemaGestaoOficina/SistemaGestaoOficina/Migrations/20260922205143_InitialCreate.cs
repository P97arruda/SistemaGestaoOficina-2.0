        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Marcacoes_Mecanicos_MecanicoId",
                        column: x => x.MecanicoId,
                        principalTable: "Mecanicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Marcacoes_Veiculos_VeiculoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Pecas = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reparacoes_Marcacoes_MarcacaoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MecanicoReparacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MecanicoReparacoes_Mecanicos_MecanicoId",
                        column: x => x.MecanicoId,
                        principalTable: "Mecanicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MecanicoReparacoes_Reparacoes_ReparacaoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marcacoes_MecanicoId",
                table: "Marcacoes",
                column: "MecanicoId");

            migrationBuilder.CreateIndex(
                name: "IX_Marcacoes_VeiculoId",
                table: "Marcacoes",
                column: "VeiculoId");

            migrationBuilder.CreateIndex(
                name: "IX_MecanicoReparacoes_MecanicoId",
                table: "MecanicoReparacoes",
                column: "MecanicoId");

            migrationBuilder.CreateIndex(
                name: "IX_MecanicoReparacoes_ReparacaoId",
                table: "MecanicoReparacoes",
                column: "ReparacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Reparacoes_MarcacaoId",
                table: "Reparacoes",
                column: "MarcacaoId");
